...
const browserDist = path.join(projectRoot, 'dist', 'spa', 'browser');
const flatDist = path.join(projectRoot, 'dist', 'spa');
...
const defaultTarget = path.resolve(projectRoot, '..', '..', 'components', 'com_balancirk', 'media', 'spa', 'browser');
...
console.log(`Angular SPA deployed to: ${targetPath}`);
