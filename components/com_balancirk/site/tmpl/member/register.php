...
<?php echo HTMLHelper::_('content.prepare', '{loadposition balancirk-member-register-top}'); ?>
...
<?php echo HTMLHelper::_('content.prepare', '{loadposition balancirk-member-register-bottom}'); ?>
