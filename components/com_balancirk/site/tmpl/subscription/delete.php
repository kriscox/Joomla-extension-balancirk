...
<?php else : ?>
	...
	<?php echo HTMLHelper::_('content.prepare', '{loadposition balancirk-subscription-delete-top}'); ?>
	...
	<?php echo HTMLHelper::_('content.prepare', '{loadposition balancirk-subscription-delete-bottom}'); ?>
